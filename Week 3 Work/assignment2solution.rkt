...
Assignment 2 Solution (please do NOT distribute)
...
(define (binplus a b)
  (cond
    ...
    [(double? a)
     (cond
       [(double? b) (double (binplus (op a) (op b)))]
       [(double-plus1? b) (double-plus1 (binplus (op a) (op b)))])]
    [(double-plus1? a)
     (cond
       [(double? b) (double-plus1 (binplus (op a) (op b)))]
       [(double-plus1? b) (double (inc (binplus (op a) (op b))))])]
    ))
...
(define (binmult a b)
  (cond
    ...
    [(double? a)
     (cond
       [(double? b) (double (double (binmult (op a) (op b))))]
       [(double-plus1? b) (double (binplus (double (binmult (op a) (op b)))
                                  (op a))) ])]
    [(double-plus1? a)
     (cond
       [(double? b) (double (binplus (double (binmult (op a) (op b)))
                                     (op b)))]
       [(double-plus1? b) (double-plus1 (binplus
                                          (double (binmult (op a) (op b)))
                                          (binplus (op a) (op b))))])]
    ))
